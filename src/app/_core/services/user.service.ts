...
export class UserService {
  ...
  public signUp(user: User): Observable<any> {
    const linkApi = `https://svcy2.myclass.vn/api/QuanLyNguoiDung/ThemNguoiDung`;
  ...
  public getUserList(): Observable<User[]> {
    let response: any = this.http.get('https://svcy2.myclass.vn/api/QuanLyNguoiDung/LayDanhSachNguoiDung?MaNhom={{GP05}}')
    return response;
  }
}
